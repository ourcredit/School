...
namespace School.Migrations
{
    ...
    [Migration("20180420023326_Iwadawdaw")]
    partial class Iwadawdaw
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("School.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("School.Models.Device", b =>
                {
                    ...
                    b.Property<int>("BillConnection");

                    b.Property<int>("BillStatus");

                    b.Property<int>("CoinConnection");

                    b.Property<int>("Cointype0Lack");

                    b.Property<int>("Cointype1Lack");
            ...
            modelBuilder.Entity("School.Models.Orders", b =>
                {
                    ...
                    b.Property<int>("pay_Channel");

                    b.Property<string>("pay_account");

                    b.Property<float>("pay_price");
            ...
            modelBuilder.Entity("School.Models.Point", b =>
                {
                    ...
                    b.Property<string>("Latitide");

                    b.Property<string>("Longitude");

                    b.Property<string>("PointAddress");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("School.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("School.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("School.Authorization.Roles.Role", b =>
                {
                    b.HasOne("School.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("School.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("School.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("School.Models.Device", b =>
                {
                    b.HasOne("School.Models.Point", "Point")
                        .WithMany()
            ...
            modelBuilder.Entity("School.Models.OperatorTree", b =>
                {
                    b.HasOne("School.Models.OperatorTree", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
